(() => {
    ...
    */        let e, t, o, n, s, i, a, r, l, d, c, v, u, b, p, g, m, f, y, x, h, L, w, k, S, C, A, P, E, q, M, T, j, H, O, z, I, V;
        ...
        function G(e) {
            ...
            P = e.hasAttribute("data-autoplay") || e.settings.autoplay, E = e.getAttribute("data-href") || e.getAttribute("href"), 
            q = e.getAttribute("data-customclass") || e.settings.customClass, I = e.getAttribute(e.settings.titleattr) || "", 
            O = e.getAttribute("data-border") || e.settings.border, M = e.hasAttribute("data-fitview") || e.settings.fitView;
        }
        function J() {
            ...
            document.body.classList.remove("vbox-open"), r.settings.focusItem && r.focus(), 
            void _({
                duration: 200,
                timing: Z,
                draw: function(e) {
        ...
        function te(e) {
            27 === e.keyCode && J(), V || (37 == e.keyCode && !0 === w && ue(H), 39 == e.keyCode && !0 === L && ue(j), 
            V = setTimeout((() => {
                V = null;
            }), 100));
        }
        function oe() {
            y = !1, a.style.opacity = 0, a.innerHTML = x, F ? (a.classList.add("vbox-grab"), 
            a.addEventListener("touchstart", ae, !1), a.addEventListener("touchend", re, !1), 
            a.addEventListener("touchmove", le, !1), a.addEventListener("mousedown", ae, !1), 
            a.addEventListener("mouseup", re, !1), a.addEventListener("mouseout", re, !1), a.addEventListener("mousemove", le, !1)) : (a.classList.remove("vbox-grab"), 
            a.removeEventListener("touchstart", ae, !1), a.removeEventListener("touchend", re, !1), 
            a.removeEventListener("touchmove", le, !1), a.removeEventListener("mousedown", ae, !1), 
            a.removeEventListener("mouseup", re, !1), a.removeEventListener("mouseout", re, !1), 
            a.removeEventListener("mousemove", le, !1));
            let e = a.querySelector(":first-child");
            e.classList.add("vbox-child"), e.style.backgroundColor = r.settings.bgcolor, e.style.transform = "scale(0.9)", 
            e.style.transition = "transform 200ms";
            let t = a.querySelector(".vbox-child img");
            t && t.addEventListener("dragstart", (function(e) {
                e.preventDefault();
            })), i.scrollTo(0, 0), e.style.transform = "scale(1)", k.style.setProperty("--vbox-padding", O), 
            k.style.setProperty("--vbox-max-width", S), W(k.classList, (function(e) {
                "vbox-overlay" !== e && k.classList.remove(e);
            })), q && k.classList.add(q), M ? a.classList.add("vbox-fit") : a.classList.remove("vbox-fit"), 
            _({
                duration: 200,
                timing: Z,
                draw: function(e) {
        ...
        function se(e, t, o) {
            ...
            if ("vimeo" == s.type || "youtube" == s.type) {
                ...
                "vimeo" == s.type ? i = "https://player.vimeo.com/video/" : "youtube" == s.type && (i = "https://www.youtube.com/embed/"), 
        ...
        function ae(e) {
            if (!y) {
                ...
                D = Q = "touchstart" === e.type ? e.touches[0].pageX : e.pageX, T = v = "touchstart" === e.type ? e.touches[0].pageY : e.pageY, 
                Y = !0;
            }
        }
        function re(e) {
            if (Y) {
                Y = !1;
                let e = r, t = !1;
                X = Q - D, X < 0 && L && (e = j, t = !0), X > 0 && w && (e = H, t = !0), Math.abs(X) >= 50 && t ? ue(e) : (a.style.marginLeft = 0, 
                a.style.opacity = 1);
            }
        }
        function le(e) {
            if (Y && !y) {
                Q = "touchmove" === e.type ? e.touches[0].pageX : e.pageX, v = "touchmove" === e.type ? e.touches[0].pageY : e.pageY, 
                d = Q - D, c = v - T;
                let t = Math.abs(d);
        ...
        function de(e) {
            ...
            }(e.href), f = document.querySelectorAll('.vbox-item[data-gall="' + z + '"]'), l = Array.prototype.indexOf.call(f, e), 
            f.length < 2 && (h = !1), f.length < 3 && (m = !1), j = f[l + 1], H = f[l - 1], 
            !j && m && (j = f[0]), !H && m && (H = f[f.length - 1]), f.length >= 1 ? (p = l + 1, 
            t.innerHTML = p + " / " + f.length) : p = 1, h ? t.classList.remove("vbox-hidden") : t.classList.add("vbox-hidden"), 
            "" !== I ? n.classList.remove("vbox-hidden") : n.classList.add("vbox-hidden"), n.innerHTML = I, 
            w = !1, L = !1, (j || m) && (L = !0), (l > 0 || m) && (w = !0), F = (w || L) && e.settings.navTouch;
            let i = k.querySelector(".vbox-next"), a = k.querySelector(".vbox-prev");
            w ? a.classList.remove("vbox-hidden") : a.classList.add("vbox-hidden"), L ? i.classList.remove("vbox-hidden") : i.classList.add("vbox-hidden"), 
            e.settings.navigation || (i.classList.add("vbox-hidden"), a.classList.add("vbox-hidden"));
        }
        function ce(t) {
            if (!t) return !1;
            e.style.backgroundColor = C, b.innerHTML = function(e) {
                ...
                return t += "</div>", t;
            }(K[t.settings.spinner]), k.style.setProperty("--sk-color", t.settings.spinColor), 
        ...
        function ve() {
            ...
            switch (r.dataset.vbtype) {
              case "iframe":
                e = E, t = A, a.classList.add("vbox-loading"), x = '<div class="venoratio venoratio-' + t + '"><iframe src="' + e + '"></iframe></div>', 
                a.classList.remove("vbox-loading"), ne("animated");
                break;
        ...
        function ue(e) {
            ...
            a.style.transition = "margin " + t + "ms ease-out, opacity " + t + "ms ease-out", 
            e === H && a.classList.add("swipe-right"), e === j && a.classList.add("swipe-left"), 
            u.classList.remove("vbox-hidden");
            const o = a.style.opacity;
            a.classList.add("vbox-animated", "vbox-loading"), N = a.cloneNode(!1), N.classList.add("cloned"), 
            N.classList.remove("swipe-left", "swipe-right"), N.style.opacity = 0, N.style.marginLeft = "0", 
            ...
            i.append(N), a = N, a.classList.remove("cloned"), de(e), _({
                ...
                timing: Z,
                draw: function(e) {
                    n.style.opacity = o - e / o, 1 === e && (n.remove(), a.classList.remove("vbox-animated"), 
                    ne("loading"), y = !1, r.settings.onNavComplete && "function" == typeof r.settings.onNavComplete && r.settings.onNavComplete(r, p, j, H));
                }
            }), ve();
        }
        function be(l) {
            ...
            !!l.settings.onPreOpen && (G(l), document.body.insertAdjacentHTML("beforeend", s), 
            ...
            k.style.opacity = 0, ce(l), de(l), a.classList.add("vbox-animated", "vbox-loading"), 
            _({
                duration: 200,
                timing: Z,
                draw: function(e) {
                    k.style.opacity = e, 1 === e && (a.classList.remove("vbox-animated"), y = !1, ne("loading"), 
                    r.settings.onPostOpen && "function" == typeof r.settings.onPostOpen && r.settings.onPostOpen(r, p, j, H));
                }
            }), ve(), l.settings.navKeyboard && (document.body.addEventListener("keydown", te), 
    ...
    function initSliders() {
        ...
        if (document.querySelector(".days__slider")) new swiper_core_Swiper(".days__slider", {
            modules: [ Navigation, Pagination, Autoplay ],
            observer: true,
            observeParents: true,
            slidesPerView: 7,
    ...
    if (openSearchBtn) openSearchBtn.addEventListener("click", (function(e) {
        this.classList.toggle("_active");
        document.getElementById("single-search").classList.toggle("_active");
        if (!this.classList.contains("_active")) this.innerHTML = '<i class="fa-solid fa-magnifying-glass"></i>'; else this.innerHTML = '<i class="fa-solid fa-xmark"></i>';
    }));
    const openFilterBtn = document.getElementById("open-filter");
    if (openFilterBtn) openFilterBtn.addEventListener("click", (function(e) {
        this.classList.toggle("_active");
    ...
    document.querySelector("#form-reviews__rating");
    if (ratingItemList) {
    ...
    if (btnViewProduct) btnViewProduct.forEach((btn => btn.addEventListener("click", viewProduct)));
    function viewProduct(e) {
        ...
        if (popupView) popupView.innerHTML = parentNodeHtml;
    }
    window["FLS"] = true;
    isWebp();
    menuInit();
