(() => {
    ...
    */        let e, t, o, n, s, i, a, r, l, d, c, v, u, b, p, g, m, f, y, x, h, L, w, k, S, C, A, P, E, q, M, T, j, H, O, z, I, V;
    ...
    if (anchorLink) anchorLink.forEach((item => {
    ...
    if (closeMenuPopup) closeMenuPopup.addEventListener("click", (function(e) {
        document.documentElement.classList.remove("lock");
        scrollUnlock();
    ...
    headerLogo.getBoundingClientRect().left;
    let zoomBtn = document.querySelectorAll(".item-list__zoombtn");
    if (zoomBtn) zoomBtn.forEach((btn => {
